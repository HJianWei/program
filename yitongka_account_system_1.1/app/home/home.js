...
angular.module('MyApp', ['ui.grid','ui.grid.selection','ui.grid.edit',
                         'ui.grid.exporter','ui.grid.pagination','ui.grid.resizeColumns','ui.grid.autoResize']).controller('HomeController', function($scope) { 
    	$scope.ttt="hello world";

    }).controller('MyCtrl', function($scope,$ocLazyLoad) {
