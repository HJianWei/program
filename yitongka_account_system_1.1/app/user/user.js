...
var app = angular.module('MyApp', ['ui.grid','ui.grid.selection','ui.grid.edit',
        ...
        app.controller('userController', function($scope,i18nService,$http) {
            // 国际化；
            ...
            var updateUser=function(obj,$http){
            	//var data="{\"userno\":\"zhangx10\",\"telephone\":\"9999999\"}";
            ...
            var getPage = function(curPage, pageSize,$http) {
            	var data="{\"userInfo\":{},\"pageNum\":\""+curPage+"\",\"pageSize\":\""+pageSize+"\"}";
            	//var data="{id:1}"; 
            	//$http.jsonp(user_url+"?callback=JSON_CALLBACK").then(function(json){alert(json);
      	        ///	$scope.navbar = json.data;alert(json.data);
          	    //});
//            	$http.get(user_url).then(function(json){alert(json.toString());
//     	        $scope.navbar = json.data;alert(json.data);
//     	    });
            	 	$http.post(user_url,data).then(function(json){
